...
public final class VehicleTypeDefaults {
	...
	public enum Type {
		...
		ALF	("ALF",	RouteType.BUS,		true,	12,		2.5,	1,		1,		VehicleType.DoorOperationMode.serial,	30,		0,		2,		true,	"AnrufLinienFahrt"),
		...
		C	("C",	RouteType.RAIL,		true,	150,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	400,	0,		20.4,	false,	"Citybahn"),
		CNL ("CNL",	RouteType.RAIL,		true,	200,	2.8,	0.5,	0.5,	VehicleType.DoorOperationMode.serial,	400,	0,		27.1,	false,	"CityNightLine"),
		CD	("CD",	RouteType.RAIL,		true,	150,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	400,	0,		20.4,	false,	"Ceske Drahy"),
		...
		ECE	("ECE",	RouteType.RAIL,		true,	205,	3,		0.5,	0.5,	VehicleType.DoorOperationMode.serial,	481,	0,		27.7,	false,	"EuroCity Express"),
		ECM	("ECM",	RouteType.RAIL,		true,	200,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	700,	0,		27.1,	false,	"EuroCity Meridian"),
		...
		FEX	("FEX",	RouteType.RAIL,		true,	150,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	400,	0,		20.4,	false,	"Flughafenexpress"),
		FLX	("FLX",	RouteType.RAIL,		true,	200,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	500,	0,		27.1,	false,	"FlixTrain"),
		...
		HBX	("HBX",	RouteType.RAIL,		true,	150,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	400,	0,		20.4,	false,	"Harz-Berlin-Express"),
		...
		MEX	("MEX",	RouteType.RAIL,		true,	150,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	400,	0,		20.4,	false,	"Metropol Express"),
		...
		REX	("REX",	RouteType.RAIL,		true,	150,	2.8,	0.25,	0.25,	VehicleType.DoorOperationMode.serial,	400,	0,		20.4,	false,	"RegionalExpress (OeBB)"),
		RJ	("RJ",	RouteType.RAIL,		true,	205,	2.9,	0.5,	0.5,	VehicleType.DoorOperationMode.serial,	400,	0,		27.7,	false,	"Railjet"),
		RJX	("RJX",	RouteType.RAIL,		true,	205,	2.9,	0.5,	0.5,	VehicleType.DoorOperationMode.serial,	400,	0,		27.7,	false,	"Railjet xpress"),
		RS	("RS",	RouteType.RAIL,		true,	300,	2.8,	0.05,	0.05,	VehicleType.DoorOperationMode.serial,	3000,	0,		40.4,	false,	"RegioS-Bahn"),
		RT	("RT",	RouteType.TRAM,		true,	20,		2.2,	0.5,	0.5,	VehicleType.DoorOperationMode.serial,	140,	0,		3.1,	true,	"RegioTram"),
		...
		SEV	("SEV",	RouteType.BUS,		true,	18,		2.5,	0.5,	0.5,	VehicleType.DoorOperationMode.serial,	70,		0,		2.8,	true,	"Schienenersatzverkehr"),
		...
		U	("U",	RouteType.SUBWAY,	true,	30,		2.45,	0.1,	0.1,	VehicleType.DoorOperationMode.serial,	300,	0,		4.4,	false,	"U-Bahn"),
