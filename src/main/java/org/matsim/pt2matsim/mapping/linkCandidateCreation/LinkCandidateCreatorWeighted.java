 ...
 * @author polettif
 */
public class LinkCandidateCreatorWeighted implements LinkCandidateCreator {
	...
	protected static Logger log = Logger.getLogger(LinkCandidateCreatorWeighted.class);
	...
	public LinkCandidateCreatorWeighted(TransitSchedule schedule, Network network, PublicTransitMappingConfigGroup config) {
